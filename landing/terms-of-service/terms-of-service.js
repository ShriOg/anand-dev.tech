// ============================================
// Terms of Service Page Interactions
// MenuNova
// ============================================
...
window.addEventListener('load', function() {
    if (window.performance && window.performance.timing) {
        ...
        console.log('Terms of Service page loaded in ' + loadTime + 'ms');
    }
...
// Prefetch home, demo, and privacy pages for faster navigation
document.addEventListener('DOMContentLoaded', function() {
    const prefetchLinks = [
        'https://menunova.me',
...
window.addEventListener('error', function(e) {
    ...
    if (window.console && console.error) {
        console.error('Error on Terms of Service:', e.message);
    }
});
