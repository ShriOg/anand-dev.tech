...
const Cart = (() => {
    ...
    const checkoutURL = () => {
        ...
        const shopName = (window.RestaurantConfig && RestaurantConfig.name) || 'Menu';
        let msg = `🛒 *New Order from ${shopName}*\n\n`;
        items.forEach(i => {
    ...
    const buildCheckoutMessage = (info, overrides = {}) => {
        ...
        const shopName2 = (window.RestaurantConfig && RestaurantConfig.name) || 'Menu';
        let msg = `🛒 *New Order — ${shopName2}*\n`;
